 ...
 * @endcode
 */
$settings['hash_salt'] = 'fn_0tQ8CF1jFPJF-2nVpzW4b_ZFWZNKmv8T_I_mMs_88_IWNTBeBmTNs5tackm51djrSIZVT3w';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_jewellery_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_jewellery_dd.inc';
}
// </DDSETTINGS>
